...
import cs from "./DataAccess.scss";
  ...
  render() {
    return (
      <div className={cs.content}>
        ...
        <Container maxWidth="lg">
          <Box my={4}>
            <div className={cs.body}>
              ...
              Tabula Microcebus Consortium and its collaborating scientists. If you
              wish to make use of restricted data for publication or are
              interested in collaborating on the analyses of these data, please use the{" "}
              <a
        ...
        <Heading title="Lemur characteristics summary" />
        <div className={cs.body}>
          {" "}
          <p></p> Data in this table is summarized from veterinary reports.
        </div>
        <LemurSummary />
        ...
        <Grid>
          <Grid item xs={12}>
            <div className={cs.body}>
              <InfoBox
                title={"Tabula Microcebus on figshare"}
                description={
